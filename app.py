...
ALLOWED_MODELS = ["google/gemini-2.5-flash-lite-preview-09-2025", "qwen/qwen3-235b-a22b", "z-ai/glm-4.7", "openai/gpt-oss-120b", "moonshotai/kimi-k2.5", "minimax/minimax-m2.1", "x-ai/grok-4.1-fast"]
# ---------- MODERATION CONFIG ----------
